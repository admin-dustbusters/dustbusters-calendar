// Weekly View - Main Calendar Grid
const WeeklyView = {
  render(data) {
    ...
    CONFIG.DAYS.SHORT.forEach(() => {
      html += '<th style="font-size: 0.75rem;">Morning</th>';
      html += '<th style="font-size: 0.75rem;">Afternoon</th>';
      html += '<th style="font-size: 0.75rem;">Evening</th>';
    });
    ...
    cleaners.forEach(cleaner => {
      ...
      html += `<td class="name-col">
        <div class="cleaner-info">
          ...
          <span class="cleaner-region" style="background: ${CONFIG.REGIONS[cleaner.region]?.color}20; color: ${CONFIG.REGIONS[cleaner.region]?.color};">
